...
public class delivery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jn.setBackground(new java.awt.Color(255, 153, 51));
        ...
        jl.setBackground(new java.awt.Color(255, 153, 51));
        jl.setFont(new java.awt.Font("Segoe UI Semibold", 1, 18)); // NOI18N

        jh.setBackground(new java.awt.Color(255, 153, 51));
        ...
        jc.setBackground(new java.awt.Color(255, 153, 51));
        ...
        jLabel6.setText("YOU SELECT Delivery .......");
    ...
    st.executeUpdate("insert into  values('"+n+"','"+c+",'"+h+"')");
    con.close();
    }
